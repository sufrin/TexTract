...
{{
\vfill
\mbox{GitHub Version \GITVERSION\ of \GITDATE}\\\mbox{(Formerly Subversion Revision: 83)}\\
\it \mbox{Copyleft
...
\ programming system}}
\author{
Fr. Saul N. Braindrane\thanks{Saul Braindrane is 
...
He is currently Tutor in Computer Science at Magdalen College. The Bernard Sufrin Fellowship in
Computer Science at Worcester College was established in 2018.}
}
\date{April 1st, 2008\\ (revised December 2020, and August 2021)}
...
\begin{alltt}
  ...
  <textract   root      = "TEXTRACT"      \textrm{Output paths are prefixed with this path}
              ...
              ans       = "ans|answer"    \textrm{pattern matching the block kind of an answer environment}
...
\begin{alltt}
 textract [switch]* [file]*
   ...
   -a                suppress classes contained within \{ans|answer\} environments (implies -c)
